...
#region MobileNet - Attention Pooling
...
# folder to store downloads models to
model_dir = 'resources'
...
def get_mobilenet(model_name: str='mn10_as', head_type: str='mlp', se_dims: str='c', checkpoint: str=None) -> MN:
    width = NAME_TO_WIDTH(model_name)
    model = get_model(width_mult=width, pretrained_name=model_name, head_type=head_type, se_dims=se_dims, num_classes=50)
